...
if ($_POST) {
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        echo '<META HTTP-EQUIV="REFRESH" CONTENT="15;URL=Registroadministrador.html">';
    } else {
        // Hashear la contraseña (utiliza la técnica de hashing que prefieras)
        $hashContrasena = password_hash($Contrasena, PASSWORD_DEFAULT);

        // Insertar los datos en la tabla "administrador"
        $query = "INSERT INTO `administradores`(`id`, `nombres`, `apellidop`, `apellidom`, `correo`, `contrasena`) VALUES ('$ID','$Nombres','$Apellido_P','$Apellido_M', '$Correo','$hashContrasena')";
        $resultado = mysqli_query($conexion, $query);
        ...
        if ($resultado) {
            ...
            echo "Error en la consulta de Administradores.";
        }
    }
    ...
    echo "ERROR";
    echo '<META HTTP-EQUIV="REFRESH" CONTENT="5;URL=Registroadministrador.html">';
}
?>
